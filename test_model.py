...
def test_mobilenet():
    ...
    train_ds, test_ds, class_names = data_load("C:/Users/86166/Desktop/keshe/new_data/train",
                                              "C:/Users/86166/Desktop/keshe/new_data/val", 224, 224, 16)

    model = tf.keras.models.load_model("models/mobilenet_vege2.h5")
    # model.summary()
    # 测试
...
def test_cnn():
    ...
    model = tf.keras.models.load_model("models/cnn_vegebable2.h5")
    # model.summary()
    # 测试
    loss, accuracy = model.evaluate(test_ds)
    # 输出结果
