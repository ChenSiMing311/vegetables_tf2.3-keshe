...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        # 模型初始化
        self.model = tf.keras.models.load_model("models/mobilenet_vege2.h5")
        self.to_predict_name = "images/cmliulian.jpeg"
        self.class_names = ['丝瓜', '哈密瓜', '土豆', '圣女果', '大白菜', '大葱', '梨', '榴莲', '油菜', '胡萝卜', '芒果', '苦瓜', '苹果', '草莓', '荔枝', '葡萄', '西瓜', '西红柿', '韭菜', '香蕉', '黄瓜']  # todo 修改类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        label_super = QLabel("作者：csm")
        label_super.setFont(QFont('宋体', 15))
        ...
        self.addTab(about_widget, '搜索')
        self.setTabIcon(0, QIcon('images/首页.png'))
        self.setTabIcon(1, QIcon('images/搜索.png'))
