...
train_ds, val_ds, class_names = data_load("C:/Users/86166/Desktop/keshe/vegetables_tf2.3-master/data", 224, 224, 20)
model = keras.models.load_model("C:/Users/86166/Desktop/keshe/vegetables_tf2.3-master/models/mobilenet_vege2.h5", compile=True)
...
def plotcm(cm):
    ...
    classes = [str(i) for i in range(21)]
